(() => {
    ...
    (() => {
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    init: function(swiper) {
                        const allSlides = document.querySelector(".fruction-controll__all");
                        allSlides.innerHTML = swiper.slides.length;
                    },
                    slideChange: function(swiper) {
                        const currentSlide = document.querySelector(".fruction-controll__current");
        ...
        const menuBlocks = document.querySelectorAll(".header__sub-catalog__body");
        if (menuBlocks.length) menuBlocks.forEach((menuBlock => {
            const menuBlockItems = menuBlock.querySelectorAll(".catalog__sub-menu__category").length;
            menuBlock.classList.add(`.header__sub-catalog__body_${menuBlockItems}`);
        }));
        function documentActions(e) {
            ...
            if (targetElement.closest(".header__top__menu__link__catalog")) {
                document.documentElement.classList.add("catalog-open");
                e.preventDefault();
            }
            if (targetElement.closest(".catalog__menu__back")) {
                document.documentElement.classList.remove("catalog-open");
                document.querySelector("._sub-menu-active") ? document.querySelector("._sub-menu-active").classList.remove("_sub-menu-active") : null;
                document.querySelector("._sub-menu-open") ? document.querySelector("._sub-menu-open").classList.remove("_sub-menu-open") : null;
                e.preventDefault();
            }
            if (targetElement.closest(".catalog__sub-menu__back")) {
                document.documentElement.classList.remove("sub-menu-open");
                document.querySelector("._sub-menu-active") ? document.querySelector("._sub-menu-active").classList.remove("_sub-menu-active") : null;
                document.querySelector("._sub-menu-open") ? document.querySelector("._sub-menu-open").classList.remove("_sub-menu-open") : null;
                e.preventDefault();
